        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 bg-[#0a0904]/70 backdrop-blur-md border border-amber-900/30 p-8 rounded-xl shadow-xl">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-amber-100/80 mb-4 leading-relaxed">
              The <strong className="text-amber-400 font-bold">SRMIST Quantum Communication Lab (SQ|QuIC)</strong> was established in partnership with <strong className="text-amber-400 font-bold">Qkrishi Quantum Private Limited</strong>.
            </p>
        ...
        <div className="bg-[#0a0904]/70 backdrop-blur-md border border-amber-900/30 p-8 rounded-xl shadow-xl mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-amber-500 text-sm font-medium">Professor & Associate Chairperson, School of Computing</p>
            </div>
          </div>
        </div>
